...
@WebServlet(description = "GuestBook Application using servlets.", urlPatterns = "/Guestbook/AddEntryServlet")
public class AddEntry extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("			<form action=\"/cs3220stu54/Guestbook/AddEntryServlet\" method=\"post\">");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {		
		...
		if ( name != null && name.trim().length() > 0 && message != null && message.trim().length() > 0 ) {		
			...
			response.sendRedirect("/cs3220stu54/Guestbook/AddEntryServlet?errorCheck=1");
		}
	}
