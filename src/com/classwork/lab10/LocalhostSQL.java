...
public class LocalhostSQL extends HttpServlet {
	...
	protected void doGet( HttpServletRequest request, HttpServletResponse response ) throws ServletException, IOException {
		...
		out.print( "<html><head><title>Localhost::JDBC</title></head>\n<body>" );

		try {
			Connection c = (new DatabaseConnection()).getLocalhostSQLConnection();
