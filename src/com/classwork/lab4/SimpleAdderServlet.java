...
@WebServlet(description = "Simple Adder Servlet.", urlPatterns = {"/requests/SimpleAdder"})
public class SimpleAdderServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("			<hr/><a class=\"btn btn-primary\" href=\"./simpleadder.html\">Back to form</a>");
		out.println("		</div>");
		out.println("	</body>");
