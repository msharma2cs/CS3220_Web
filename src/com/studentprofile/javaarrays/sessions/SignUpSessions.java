...
@WebServlet(description = "Student Profile Application using sessions and java arraylist.", urlPatterns= {"/Student/Sessions/Signup"})
public class SignUpSessions extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("        <meta name=\"description\" content=\"Student Profile Application using java arraylist and sessions - Signup page, create a new student user.\">");
		...
		out.println("        <title>Student::SignUp(Sessions)</title>");
		out.println("    </head>");
		out.println("");
		/* Page Body goes here */
		out.println("    <body>");
