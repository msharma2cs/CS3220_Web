...
@WebServlet(description = "Student Profile Application using cookies and java arraylist.", urlPatterns = {"/Student/Cookies/Signup"})
public class SignUpCookies extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if ( student != null ) {
			...
			response.sendRedirect("cookies/MyProfile");
			return;
		}
		...
		out.println("        <meta name=\"description\" content=\"Student Profile Application using Cookies and Java Arraylist - Signup page, create a new student user.\">");
		...
		out.println("        <title>Student::Signup(Cookies)</title>");
		out.println("    </head>");
		out.println("");
		/* Page Body goes here */
		out.println("    <body>");
		...
		out.println("				<br><p>Already a user? <a href=\"Login\" target=\"_parent\"> Login Here</a>");
		out.println("			</form>");
		out.println("        </div>");
		out.println("");
		out.println("    </body>");
