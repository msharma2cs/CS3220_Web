...
@WebServlet(description = "Student Profile Application using cookies and java arraylist.", urlPatterns = {"/Student/Cookies/Login"}, loadOnStartup = 4)
public class LoginCookie extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("        <meta name=\"description\" content=\"Student Profile Application using Cookies and Java Arraylist - Login page, remembers user by using cookies.\">");
		...
		out.println("        <title>Student::Login(Cookies)</title>");
		out.println("    </head>");
		out.println("");
		/* Page Body goes here */
		out.println("    <body>");
