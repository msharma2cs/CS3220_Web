...
@WebServlet(description = "Student Profile Application using cookies and java arraylist.", urlPatterns = {"/Student/Cookies/MyProfile"})
public class StudentProfileCookie extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("       	<meta name=\"description\" content=\"Student Profile Application using Cookies and Java Arraylist - Profile page: Shows details of logged in user.\">");
		...
		out.println("        <title>Student::Profile(Cookies)</title>");
		out.println("    </head>");
		out.println("");
		/* Page Body goes here */
		out.println("    <body>");
